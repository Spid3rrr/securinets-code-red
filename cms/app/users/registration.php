...
<html lang="en">
  <head>
    ...
    <title>CMS | Utulisateur  Enregistrement</title>
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" method="post">
		        <h2 class="form-login-heading">Enregistrement de l'utulisateur</h2>
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <button class="btn btn-theme btn-block"  type="submit" name="submit" id="submit"><i class="fa fa-user"></i> Enregistrement</button>
		            <hr>
