...
<html lang="en">
  <head>
    ...
    <title>TMS | Tableau de bord</title>
...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?> Ticket pas encore Traitée</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Status Ticket: en cours </p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Ticket traitée</p>
                      </div>
