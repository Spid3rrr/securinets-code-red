...
<html lang="en">
  <head>
    ...
    <title>PMS | Utulisateur Changer mot de passe</title>
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Utulisateur Changer mot de passe</h4>
...
<div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Confirmez mot de passe</label>
                              <div class="col-sm-10">
