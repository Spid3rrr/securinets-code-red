...
<html lang="en">
  <head>
    ...
    <title>TMS | Utulisateur  Enregistrer un Ticket</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Enregistrer un Ticket</h3>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"> Type de Tickets</label>
<div class="col-sm-4">
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Panne</option>
                  <option value="General Query">Requete genérale</option>
                </select> 
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Nature du Ticket</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Details du Tickets (max 2000 mots) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Dossier relatif au Ticket (Joindre fichier)</label>
<div class="col-sm-6">
