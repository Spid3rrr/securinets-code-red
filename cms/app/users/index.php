...
<html lang="en">
  <head>
    ...
    <title>TMS |  Connexion Utulisateur </title>
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" name="login" method="post">
				...
				<br><br>
				<p id="align">hdhdhdh</p4><img src="hannibal.jpg" width="220" height="220"><p id="align">hdhdhd</p4>
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            ...
		            <button class="btn btn-theme btn-block" name="submit" type="submit"><i class="fa fa-lock"></i> Se connecter</button>
		            <hr>
		           </form>
		            <div class="registration">
		                Vous n'avez toujours pas un compte?<br/>
		              ...
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      ...
		                      <div class="modal-body">
		                          <p>Entrez vos details au dessous pour renitialiser  votre mot de passe .</p>
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
    ...
    <script>
        $.backstretch("assets/img/backgroundGris.jpg", {speed: 500});
    </script>
