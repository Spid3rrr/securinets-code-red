...
if($query)
{
$successmsg="Profil a jour !!";
}
else
{
$errormsg="Erreur de la mise a jour du Profil   !!";
}
}
?>
...
<html lang="en">
  <head>
    ...
    <title>TMS | Utulisateur Changer Mot de passe</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Profil info</h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <b>Tres bien!</b> <?php echo htmlentities($successmsg);?></div>
                      <?php }?>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      <b>Attention!</b> </b> <?php echo htmlentities($errormsg);?></div>
                      <?php }?>
 ...
 ?>                     
  ...
  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['fullName']);?>'s Profile</h4>
    ...
    <h5><b>Derniére mise a jour :</b>&nbsp;&nbsp;<?php echo htmlentities($row['updationDate']);?></h5>
           <form class="form-horizontal style-form" method="post" name="profile" >
                        
          
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Nom et prenom</label>
<div class="col-sm-4">
<input type="text" name="fullname" required="required" value="<?php echo htmlentities($row['fullName']);?>" class="form-control" >
 </div>
<label class="col-sm-2 col-sm-2 control-label">Email Utulisateur </label>
 <div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">Addresse </label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">Continent </label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">code Pin</label>
<div class="col-sm-4">
<input type="text" name="pincode" maxlength="6" required="required" value="<?php echo htmlentities($row['pincode']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label">Date d'inscription </label>
<div class="col-sm-4">
