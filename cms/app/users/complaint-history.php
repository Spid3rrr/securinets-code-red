...
<html lang="en">
  <head>
    ...
    <title>TMS | Historique  des Tickets</title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Mon historique de plainte</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                              ...
                              <tr>
                                 ...
                                 ?></td>
                                  <td align="center"><?php 
                                    ...
                                    { ?>
                                      <button type="button" class="btn btn-theme04">Pas encore Traitée</button>
                                   <?php }
...
if($status=="closed") {
?>
<button type="button" class="btn btn-success">Traitée</button>
<?php } ?>
                                   <td align="center">
                                   <a href="complaint-details.php?cid=<?php echo htmlentities($row['complaintNumber']);?>">
<button type="button" class="btn btn-primary">Voir Details</button></a>
                                   </td>
                                </tr>
                              <?php } ?>
