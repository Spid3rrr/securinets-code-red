...
<head>
	...
	<title>Admin| Details des Plaintes</title>
...
?>									
										<tr>
											<td><b>nombre de la plainte</b></td>
											<td><?php echo htmlentities($row['complaintNumber']);?></td>
											<td><b>Nom de la plainte</b></td>
											<td> <?php echo htmlentities($row['name']);?></td>
											<td><b>Date de l'inscription</b></td>
...
<tr>
											...
											<td><b>Sous Categorie</b></td>
											<td> <?php echo htmlentities($row['subcategory']);?></td>
											<td><b> Type de la plainte</b></td>
...
<tr>
											...
											<td ><b>Nature de la plainte</b></td>
											<td colspan="3"> <?php echo htmlentities($row['noc']);?></td>
											
										</tr>
<tr>
											<td><b> Details de la plainte </b></td>
...
<tr>
											<td><b>Document(preuve si dispo..) </b></td>
...
<a href="http:///complaint-management-system/Complaint%20Management%20System/users/complaintdocs/<?php echo htmlentities($row['complaintFile']);?>" ?> voir Document</a>
<?php } ?></td>
</tr>
...
<tr>
<td><b>Remarque</b></td>
<td colspan="5"><?php echo  htmlentities($rw['remark']); ?> <b> Date de la remarque <?php echo  htmlentities($rw['rdate']); ?></b></td>
</tr>
...
<tr>
<td><b>Etat final</b></td>
											
											<td colspan="5"><?php if($row['status']=="")
											{ echo "Pas encore Traitéé";
} else {
